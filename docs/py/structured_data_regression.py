...
clf = ak.StructuredDataRegressor(max_trials=3) # It tries 10 different models.
...
print(clf.evaluate(test_file_path, 'Price'))
...
clf = ak.StructuredDataRegressor(max_trials=3)
# Feed the structured data regressor with training data.
