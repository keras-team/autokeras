...
import torch
from autokeras.legacy.nn.generator import CnnGenerator, ResNetGenerator, DenseNetGenerator
from autokeras.legacy.nn.graph import NetworkDescriptor
from autokeras.legacy.nn.layers import StubReLU
from tests.legacy.common import get_conv_data, get_add_skip_model, get_conv_dense_model, get_pooling_model, \
