...
from autokeras.legacy.nn.layer_transformer import wider_pre_dense, wider_next_dense, wider_bn, wider_pre_conv, \
    wider_next_conv
from autokeras.legacy.nn.layers import StubDense, StubBatchNormalization2d, StubConv2d
from tests.legacy.common import get_conv_dense_model
