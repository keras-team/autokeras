...
from autokeras.legacy.backend.tensorflow import classification_loss
from autokeras.legacy.bayesian import edit_distance
from autokeras.legacy.constant import Constant
from autokeras.legacy.nn.generator import CnnGenerator, ResNetGenerator, MlpGenerator
from autokeras.legacy.nn.metric import Accuracy
from autokeras.legacy.search import BayesianSearcher
from tests.legacy.common import clean_dir, MockProcess, get_classification_data_loaders, get_classification_data_loaders_mlp, \
