from autokeras.legacy.backend import Backend, tensorflow, torch
from autokeras.legacy.nn.generator import CnnGenerator
from autokeras.legacy.nn.metric import Accuracy, MSE
from autokeras.legacy.backend.tensorflow.model_trainer import ModelTrainer
from tests.legacy.common import get_classification_data_loaders, \
